...
public class TestGenericST_AzimuthUDF {
	@Test
	public void shouldEqual() throws HiveException, IOException {
		...
		DoubleWritable expected = new DoubleWritable(2.4264066074139135);
